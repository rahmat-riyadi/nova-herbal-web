    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            ...
            <div class="card-toolbar">
                <!--begin::Button-->
                <a href="/admin/admin/create" class="btn btn-primary font-weight-bolder">
                        ...
                        @foreach ($admin as $key => $item)
                            <tr>
                                ...
                                <td class="pr-0 text-right">
                                    <a href="/admin/patient/show/{{ $item->id }}" class="btn btn-transparent-success font-weight-bold mr-2">Lihat</a>
        ...
        var demo = function() {
            ...
            var datatable = $('#kt_datatable').KTDatatable({
                ...
                columns: [{
                    ...
                    template: function(e) {
                        return `\
                            <a href="/admin/admin/show/${e.id}" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">\
                                <span class="svg-icon svg-icon-md">\
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\
                                            <rect x="0" y="0" width="24" height="24"/>\
                            ...
                            <a href="javascript:;" class="btn btn-sm btn-clean btn-icon" title="Delete" data-toggle="modal" data-target="#exampleModalCenter" >\
                                <span class="svg-icon svg-icon-md">\
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\
                                            <rect x="0" y="0" width="24" height="24"/>\
            ...
            $('#kt_datatable_search_query').keyup((e) => {
                datatable.search(e.target.value).redraw();
            })
