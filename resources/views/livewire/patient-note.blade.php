<div class="table-responsive" style="max-height: 350px;" >
    ...
    <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <span class="text-dark-75 font-weight-bold d-block font-size-lg">{{ $item->note }}</span>
                </td>
                <td class="pr-0 text-right">
                    <a 
                        ...
                        title="Edit details"
                        data-patient-id="{{ $item->patients_id }}"
                        data-note-id="{{ $item->id }}"
                        data-note="{{ $item->note }}"
                        data-note-date="{{ Carbon\Carbon::parse($item->date)->format('Y-m-d') }}"
                        onclick="handleEditNote(this)"
                    >
    ...
    <div class="modal fade" id="confirmDeleteNote" tabindex="-1" role="dialog" aria-labelledby="confirm" aria-hidden="true">
